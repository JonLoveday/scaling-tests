...
def cluster_z(adir='BGS_S_w_z', xdir='BGS_S_w_z_m', njack=10, nz=12, nm=4,
              fit_range=[0.001, 1], p0=[0.05, 1.7], rmin=0.01, rmax=10):
    """Cluster redshifts from angular clustering of galaxies in mag bins about
    reference sample in redshift bins.
    Reference sample autocorrelations in redshift bins are in directory adir.
    Cross-correlations between reference redshift bins and tracer mag bins are in xdir."""
